  ...
  <div style="position: absolute;display: flex;flex-direction: column;align-items: center;width: 100%;min-width: 1440px">
    ...
    <div id="exhibitionHome">
      ...
      <div style="display: flex;top: 0;width: 100%;justify-content: space-between">
        ...
        <img :src="path2[1].imgUrl" alt="走进艺链智绘" class="image">
      </div>
  ...
  data() {
    return {
      ...
      path2: [
        ...
        {imgUrl: this.$store.state.imgBaseUrl+"/%E6%95%B0%E5%AD%97%E5%8D%9A%E7%89%A9%E9%A6%86%E9%A6%96%E9%A1%B5-04.png", title: "走进艺链智绘", url: "/enter"}
      ],
      normalTitle: [
        { title: "首页", url: "/home" },
